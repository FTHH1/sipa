<div class="space-y-4">
        ...
        <table class="w-full border-collapse">
            <thead>
                <tr class="border-b bg-zinc-100 dark:bg-zinc-800">
                    ...
                    <th class="px-4 py-3 text-center text-sm font-semibold">No HP</th>
                    <th class="px-4 py-3 text-center text-sm font-semibold">Alamat</th>
    ...
    @foreach($users as $user)
        <tr class="border-b hover:bg-zinc-50 dark:hover:bg-zinc-700 transition">
            ...
            <td class="px-4 py-3 text-center text-sm max-w-xs truncate">
                {{ $user->alamat ?? '-' }}
            </td>
            ...
            <td class="px-4 py-3 text-center">
                <a
                    ...
                    class="text-zinc-600 hover:underline font-medium"
                >
                    Edit
                </a>
            </td>
